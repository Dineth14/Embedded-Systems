...
\begin{tikzpicture}[
  ...
  % Prediction labels
  \node[below=0.5cm of SNT, font=\scriptsize\itshape, text=ee-red] {Predict:\\Not Taken};
  \node[below=0.5cm of WNT, font=\scriptsize\itshape, text=ee-red] {Predict:\\Not Taken};
  \node[below=0.5cm of WT, font=\scriptsize\itshape, text=ee-green!70!black] {Predict:\\Taken};
  \node[below=0.5cm of ST, font=\scriptsize\itshape, text=ee-green!70!black] {Predict:\\Taken};
...
\begin{tikzpicture}[
  ...
  \node[font=\scriptsize\ttfamily, anchor=east] at (-3.2, {sram.south |- sram.south}) {\hex{2000\_0000}};
  \node[font=\scriptsize\ttfamily, anchor=east] at (-3.2, {periph.south |- periph.south}) {\hex{4000\_0000}};
  \node[font=\scriptsize\ttfamily, anchor=east] at (-3.2, {sys.south |- sys.south}) {\hex{E000\_0000}};
  \node[font=\scriptsize\ttfamily, anchor=east] at (-3.2, {sys.north |- sys.north}) {\hex{E00F\_FFFF}};
