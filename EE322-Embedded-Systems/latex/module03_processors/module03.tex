...
\begin{tikzpicture}[
  ...
  % Annotation
  \node[font=\scriptsize\itshape, text=ee-gray, anchor=north west, align=left] at (-6.5, -2.5) {Three simultaneous memory accesses:\\1. Instruction fetch (PM bus)\\2. Data read (DM bus)\\3. Data read (PM data bus)};
